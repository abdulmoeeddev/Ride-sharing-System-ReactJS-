  ...
  return (
    <section className="aboutUs">
      ...
      <div className="container">
        ...
        <h3>
          Welcome To <strong>Ride Sharing</strong>
        </h3>
        <p>
          <strong>Ride Sharing</strong> is a Professional Ride sharing Platform.
        ...
        <ul>
          ...
          <li>
            Thousand of kilometers shared by community since Ride Sharing creation
          </li>
        </ul>
        <p>
